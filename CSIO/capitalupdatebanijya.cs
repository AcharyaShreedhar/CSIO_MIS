...
namespace CSIO
{
    public partial class capitalupdatebanijya : Form
    {
        public capitalupdatebanijya()
        {
            InitializeComponent();
        }
        ...
        public void DisplayData()
        {
            ...
            MySqlDataAdapter qry = new MySqlDataAdapter("SELECT     banijyaform.firmid, GetNumberToUnicode(banijyaform.firmregno) AS 'र.नं', banijyaform.firmnepname AS 'फर्मको नाम', GetNumberToUnicode(banijyaform.revenue) AS 'पुँजी'  From  banijyaform where banijyaform.firmid=@darta ", sqlcon.con);
        ...
        private void capitalupdatebanijya_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (k > 0)
                {
                    ...
                    // DisplayData();
                    // cleardata();
                    MySqlCommand qrs = new MySqlCommand("UPDATE banijyaform  SET revenue = GetUnicodeToNumber(@txtbxthree)   WHERE firmid=@indid");
                    ...
                    if (n > 0)
                    {
                        ...
                        MessageBox.Show("फमको पुँजी र्संशोधन सफल भयो ।", "संशोधन", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                        Cleardata();
