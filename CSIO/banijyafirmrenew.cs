...
namespace CSIO
{
    public partial class banijyafirmrenew : Form
    {
        public banijyafirmrenew()
        {
            InitializeComponent();
        }
        ...
        private void banijyafirmrenew_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (k > 0)
            {
                ...
                // DisplayData();
                // cleardata();
                MySqlCommand qrs = new MySqlCommand("UPDATE banijyaform  SET renewdate = GetUnicodeToNumber(@txtbxthree)   WHERE firmid=@indid");
                ...
                if (n > 0)
                {
                    ...
                    MessageBox.Show("फमको नविकरण र्संशोधन सफल भयो ।", "संशोधन", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                    Cleardata();
