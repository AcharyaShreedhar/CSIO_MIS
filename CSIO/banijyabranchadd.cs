...
namespace CSIO
{
    public partial class banijyabranchadd : Form
    {
        public banijyabranchadd()
        {
            InitializeComponent();
        }
        ...
        public void DisplayData()
        {
            ...
            MySqlDataAdapter qry = new MySqlDataAdapter("SELECT     banijyaform.firmid, GetNumberToUnicode(banijyaform.firmregno) AS 'र.नं', banijyaform.firmnepname AS 'फर्मको नाम', banijyaform.branch AS 'शाखा'  From  banijyaform where banijyaform.firmid=@darta ", sqlcon.con);
        ...
        private void banijyabranchadd_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (k > 0)
            {
                ...
                // DisplayData();
                // cleardata();
                MySqlCommand qrs = new MySqlCommand("UPDATE banijyaform  SET branch = @txtbxthree   WHERE firmid=@indid");
                ...
                if (n > 0)
                {
                    ...
                    MessageBox.Show("फमको शाखा र्संशोधन सफल भयो ।", "संशोधन", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                    Cleardata();
